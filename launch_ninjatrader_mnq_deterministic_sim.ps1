...
Write-Host "CONTRACTS PER TRADE: 5"
Write-Host "PROFIT TARGET: 35 POINTS"
Write-Host "STOP: STRUCTURAL INVALIDATION"
Write-Host "MAXIMUM STOP DISTANCE: 20 POINTS"
Write-Host "MAXIMUM GROSS TRADE RISK: `$200"
Write-Host "MAXIMUM TRADES: 2"
Write-Host "DAILY LOSS CEILING: `$500"
